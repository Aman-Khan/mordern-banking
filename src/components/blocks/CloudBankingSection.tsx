  ...
  return (
    <section className="relative w-full min-h-[800px] bg-[#000D12] flex items-center py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute left-[6%] top-1/2 -translate-y-1/2 select-none pointer-events-none z-0">
        <span
          className="text-[400px] lg:text-[650px] font-archivo font-medium text-transparent opacity-30"
      ...
      <div className="max-w-[1440px] mx-auto w-full px-6 lg:px-16 flex flex-col lg:flex-row items-center gap-16 lg:gap-8 relative z-10">
        ...
        {/* =========================================
            ...
            ========================================= */}
        {/* RIGHT COLUMN: Pure CSS Laptop Mockup (Moved Right) */}
        <div className="flex-1 w-full max-w-[800px] relative mt-16 lg:mt-0 flex flex-col items-center translate-x-[60%]">

          {/* Laptop Screen (Top Half) */}
          <div className="relative w-full aspect-[24/10] border-[1.5px] border-[#00B4FD]/70 rounded-t-[24px] rounded-b-sm bg-[#000D12] p-2 lg:p-4 pb-0 z-10 shadow-[0_0_50px_rgba(0,180,253,0.1)]">
          ...
          <div className="relative w-[110%] h-3 lg:h-6 border-[1.5px] border-[#00B4FD]/70 rounded-b-[12px] rounded-t-sm bg-[#000D12] z-20" />
